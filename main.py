...
boot_line("Beginning memory test...", 9, delay=3)
...
t.gen_text("Welcome to Laura Arango's profile!", 9)
t.clone_frame(15)
t.clear_frame()
...
t.gen_typing_text(text="Laura-Arango", row_num=1, col_num=14, contin=True, speed=0.1)
t.clone_frame(10)
...
t.clear_frame()
t.gen_text(text="Welcome, Laura! Last Login: 01-01-1970T00:00:01", row_num=1)
t.set_prompt("\x1b[35mBryan's stuff\x1b[39m@\x1b[32mgithub\x1b[39m:~$ ")
t.gen_prompt(2)
t.gen_typing_text(text="ghfetch -u Laura-Arango", row_num=2, contin=True, speed=0.1)

gh_stats = gifos.utils.fetch_github_stats("Laura-Arango")
...
t.gen_typing_text(
    text="cat /proc/programmingLanguages | head -n 4", row_num=9, contin=True, speed=0.1
)
...
t.gen_text(text="\x1b[29mGitHubActions", row_num=14)

t.gen_prompt(t.curr_row)
t.gen_typing_text(
    text="cat /proc/Infrastructure Config and Automation Tools | head -n 4", row_num=15, contin=True, speed=0.1
)
